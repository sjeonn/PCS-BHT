...
def create_data(apps, schema_editor):
    ...
    for result in cl_h.get_results(sort_by='newest', geotagged=True):
        Listing(address = result['where'], email = "", price = result['price'], rooms = "", photo = "https://sfbay.craigslist.org/eby/roo/d/berkeley-lovely-private-sunny-very/7405635388.html")
